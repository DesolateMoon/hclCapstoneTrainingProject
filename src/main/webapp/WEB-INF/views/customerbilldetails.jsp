...
<body>
	...
	<div style="max-width: 750px; margin: auto; border: 1px solid black; padding: 10px; margin-top: 30px; height: 970px; position: relative;"
		...
		<div>
			...
			<form class="form-group" method="post" action="/checkout/billing">
				<h2 style="margin-top: 3%"card-title">Customer Billing Details</h2>
				...
				<input class="form-control" type="text" name="billAddress" required="required" value="<%=u.getBillAddress()%>">
				<label class="card-header">City</label> 
				<input class="form-control" type="text" name="billCity" required="required" value="<%=u.getBillCity()%>">
				<label class="card-header">State</label> 
				<input class="form-control" type="text" name="billState" required="required" value="<%=u.getBillState()%>">
				<label class="card-header">Country</label> 
				<input class="form-control" type="text" name="billCountry" required="required" value="<%=u.getBillCountry()%>">
				<label class="card-header">Zipcode</label> 
				<input class="form-control" type="text" name="billZipcode" required="required" value="<%=u.getBillZipcode()%>">
